...
| LSFT     | LALT      | LCTL        | LGUI       |         |       | LGUI       | LCTL        | LALT      | LSFT     |
...
| PIPE        | SE_PIPE          | PIPE          | U_PIPE        |
| PLUS        | SE_PLUS          | PLUS          | +             |
| PSCR        | PSCR             | PSCRN         | sysrq         |
| QUES        | SE_QUES          | QMARK         | ?             |
| QUOT        | SE_QUOT          | SQT           | U_QUOT        |
| RBRC        | SE_RBRC          | RBKT          | ]             |
| RCBR        | SE_RCBR          | RBRC          | }             |
| RESET       |                  | &reset        |               |
...
#+NAME: nonkc
| U_ | RGB_ | OU_  | QK_ | S( | C( | SCMD( | LCMD( | TD( | CW_TOGG | SE_ | 
